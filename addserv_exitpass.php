...
?>
          ...
          <div class="card overflow-auto m-3 s-6" style="height:650px;">
              <div class="card-body">
              <nav aria-label="breadcrumb">
               <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="mainserv_entrypass.php">Entry Pass</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Exit Pass</li>
                </ol>
                </nav>
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <table class="table table-striped">
                                  ...
                                  <tr>
                                    <td>Official Schedule</td>
                                    <td><?php echo $row['official_schedule_time']; ?></td>
                                  </tr>
                                  <tr>
                                      <td>Time Left </td>
                                  ...
                                  <?php
                                      ...
                                      $sql = "UPDATE ss_add_student_exit_pass SET status='$status', received_by='$received_by'WHERE id = '$id'";
...
if(isset($_SESSION['success']) && $_SESSION['success']!=''){
  ...
  window.location.href = "addserv_exitpass.php";
});
  </script>
  <?php
