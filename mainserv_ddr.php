  ...
  <?php include "partial/sidebar.php";?>
        ...
        <div class="card overflow-auto" style="height:650px;">
             ...
             <nav aria-label="breadcrumb">
               <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="mainserv_transportation.php">Transportation</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Disaster Risk Reduction</li>
                </ol>
                </nav>
                <div class="card" style="height:150px;">
                 <div class="card-body shadow-lg p-3 mb-5 bg-body-tertiary rounded">
                    <p class="fw-bold text-center">Disaster Risk Reduction<br>Standard No.12 </p>
                    <p class="fw-bold text-center">
                    Disaster means an emergency event that occurs with little or no warning, causing extensive destruction of prosperity, lives and  disruption of normal operations.
                    </p>
                     </div>
                </div>
             ...
             <div class="container"> 
                 <div class="row">
                    ...
                    <button class="btn btn-primary" onclick="printTable()"> <i class='bx bx-printer'> &nbsp;Print Table</i></button>  
                                ...
                                $query = "SELECT * FROM `ss_mservices` where school_safety_standard ='12'"; // change database table name for other data fetching
                                    $query_run = mysqli_query($conn, $query);
                                ?>
                                    <table id="ddr_table" class="table table-striped table-bordered">
  ...
  !-- for print table  -->
        <script>
                function printTable() {
                    ...
                    var table = document.getElementById("ddr_table");
